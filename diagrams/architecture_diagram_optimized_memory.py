...
# Create the diagram
with Diagram("AWS Chatbot with Text-to-SQL Architecture (Parquet Optimized)", show=False, filename="architecture_diagram_optimized_memory", outformat="png"):
    ...
    with Cluster("Processing Layer"):
        ...
        with Cluster("Query Processing (20 Concurrent)"):
    ...
    with Cluster("Conversation Memory (30 per user)"):
        dynamodb = Dynamodb("Conversation History")
        memory_lambda = LambdaFunction("Memory Manager")
        
        query_lambda >> memory_lambda
        memory_lambda >> dynamodb
        result_lambda >> memory_lambda
